...
const HeroSkeleton = () => (
  <div className="grid lg:grid-cols-2 gap-12 items-center">
    ...
    <div className="flex flex-col justify-center">
      ...
      <Skeleton className="h-10 w-full md:w-3/4 lg:w-2/3 mb-6" />
      <Skeleton className="h-6 w-full md:w-2/3 mb-4" />
      <Skeleton className="h-6 w-1/2 mb-8" />
      <Skeleton className="h-12 w-40 rounded-lg" />
    </div>

    {/* Right Skeleton - Image Placeholder */}
    <div className="relative w-full min-h-[400px] lg:min-h-[700px] bg-gray-800 rounded-2xl lg:rounded-l-[3rem]">
